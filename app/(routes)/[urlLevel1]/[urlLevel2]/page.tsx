...
import { fetchItemsByLevel2 } from "@/app/lib/data";
...
export default async function Page({
  params: { urlLevel2 }, // urlVariety optional passed as array
}: CategoryParamsProps) {
  console.log(urlLevel2);

  if (urlLevel2) {
    const query = deHyphenate(urlLevel2);
    if (query) {
      const promise: Promise<ItemsProps[] | undefined> = fetchItemsByLevel2(
